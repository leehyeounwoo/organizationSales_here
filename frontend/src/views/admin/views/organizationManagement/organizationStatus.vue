			...
			<v-flex xs4 class="ml-10 mt-5">
				...
				<!-- <v-layout>
					...
					<v-flex xs10 class="notice_right_table2">
						<v-layout>
							<v-flex xs3>
								<txtField :txtField="detailData.name" v-model="detailData.name.value" class="search_box_admin py-3 px-1"></txtField>
							</v-flex>
							<v-flex xs3>
								<txtField :txtField="detailData.phone" v-model="detailData.phone.value" class="search_box_admin py-3 pr-1"></txtField>
							</v-flex>
							<v-flex xs3>
								<selectBox :sel="detailData.sex" class="searchSel py-3 pr-1" style="font-size:12px"></selectBox>
							</v-flex>
							<v-flex xs3>
								<selectBox :sel="detailData.age" class="searchSel py-3 pr-1" style="font-size:12px"></selectBox>
							</v-flex>
						</v-layout>
					</v-flex>
				</v-layout>
